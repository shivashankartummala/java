...
public class MinimumEditDistance {
	 ...
	 public static void main(String args[]){
	        ...
	        int result = minimumEditDistance.dynamicProgrammingEditDistance(str1.toCharArray(), str2.toCharArray());
     ...
     */
    public int recursiveEditDistance(char[]  str1, char str2[], int len1,int len2){
        ...
        return min(recursiveEditDistance(str1, str2, len1 + 1, len2 + 1) + str1[len1] == str2[len2] ? 0 : 1, recursiveEditDistance(str1, str2, len1, len2 + 1) + 1, recursiveEditDistance(str1, str2, len1 + 1, len2) + 1);
    }
    
    /**
     * Uses bottom up DP to find the edit distance
     */
    public int dynamicProgrammingEditDistance(char[] str1, char[] str2){
